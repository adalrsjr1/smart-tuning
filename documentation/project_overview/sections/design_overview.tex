...
\arsj{        again this might be somehting we pick defaults for and only in
...
\arsj{best suitable for continuous domains of less then 20 dimensions}
...
After $n$ times, BO will find an, at least, quasi-optimal configuration which
